...
const StockScreen = ({ data }) => {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.place}>Place an Order
        </Text>
  
        <View style={styles.process}>
          <View style={styles.pickers}>
            <RNPickerSelect autosize={false}
          ...
          <TextInput style={styles.pickers} placeholder={'# of shares...'}>
          </TextInput>
        ...
        <View style={{marginBottom: '5%'}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <View style={{marginRight: '10%'}}>
              ...
              <Text>Total Gain/Loss: ${(data.lastPrice - data.boughtPrice) * data.shares}</Text>
            </View>
          <View>
              <Text>Last Price: ${data.lastPrice}</Text>
              <Text>Last Change: {data.upDown}{data.lastChange} ({data.upDown}{data.percentChange}%)</Text>
